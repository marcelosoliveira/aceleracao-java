package com.acceleracao.oauth2.security;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    private static final int ACCESS_TOKEN_VALIDITY_IN_SECONDS = 86400;
    private static final int REFRESH_TOKEN_VALIDITY_IN_SECONDS = 86400;
    @Autowired
