...
public class Carro {
    ...
    public static class CarroBuilder {
        ...
        public Carro build() {
           ...
           corExiste(cor);
           placaExiste(placa);
           existeMotorista(motorista);
           return carro;
        }

        public void placaExiste(String placa) throws NullPointerException {
            if (placa == null || placa.isEmpty()) {
                throw new NullPointerException();
            }
        }

        public void corExiste(Cor cor) throws NullPointerException {
            if (cor == null) {
                throw  new NullPointerException();
            }
        }

        public void existeMotorista(Motorista motorista) {
            if (motorista == null) {
